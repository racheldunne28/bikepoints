...
def gen_map(locations, ldn_geog, ldn_obesity, pop, imd):
    ...
    for s in cp.geojson.data['features']:
        ...
        s['properties']['health_deprivation'] = f"{imd.loc[s['properties']['LAD22CD'], 'health_deprivation']:.2%}"
    folium.GeoJsonTooltip(['LAD22NM', 'obesity', 'pop', 'health_deprivation'], aliases=['Local Authority', r'% adults overweight or obese', 'Population', '% LSOAs in 10% most health deprived']).add_to(cp.geojson)
